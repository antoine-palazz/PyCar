...
def graph_html_pol_par_activité():
    ...
    def transform(dataset):
        colonnes = ["Émissions de gaz à effet de serre par activité"] + [
            f"{i}" for i in range(1990, 2023)
        ]
...
def evol_accidents():
    ...
    img_base64 = base64.b64encode(img_data.read()).decode()
    graph_html = (
        f'<img src="data:image/png;base64,{img_base64}" alt="Graphique d\'autonomie">'
    )
    return graph_html
