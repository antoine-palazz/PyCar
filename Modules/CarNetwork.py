...
class CarNetwork():
    ...
    def plot_stop_points(self, map):
        ...
        legend_html = f'<div style="position: fixed; bottom: 50px; left: 50%; transform: translateX(-50%); background-color: white; padding: 10px; border: 2px solid black; border-radius: 5px;">Distance du trajet : {distance:.2f} km</div>'
